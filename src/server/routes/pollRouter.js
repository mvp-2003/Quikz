...
router.route('/').get(retrievePolls).post(authenticateUser, createPoll);
...
router.route('/:id/votes').post(authenticateUser, castVote);

router.route('/:id/results').get(retrieveLivePollResults);
